...
$q1_sd=mysql_query("SELECT sum(count) as dokopy FROM $tabulka");
$c=mysql_fetch_object($q1_sd);
$dokopy=$c->dokopy;


$q_sd=mysql_query("SELECT rating div 10 AS r, SUM(count) as mnozstvo FROM $tabulka GROUP BY rating div 10 ORDER BY rating;");

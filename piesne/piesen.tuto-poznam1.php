<div class="tuto-poznam_vnutro l-well" id="tuto-poznam_vnutro">
    <?php
    ...
    if ($_POST['odoslane_tutopoznam']=="true") {
        ...
        ?>
            <strong>Perfektné!</strong> Ďakujeme za pomoc pri mapovaní rozšírenia ľudových piesni na Slovensku.
    ...
    <form id="form_tutopoznam" method="post" class="form-inline">
        <div class="row">
            <div class="col-md-4">
                <p><strong>Vďaka!</strong> Doplníte ešte ďalšie informácie?</p>
        ...
        <fieldset class="form-group">
            <small class="text-muted">Rok narodenia:</small>

            <select class="form-control form-control-sm" id="rok_narodenia" name="rok_narodenia">
                <?php
            ...
            <div class="col-md-3">
        <fieldset class="form-group">
            <small class="text-muted">Odkiaľ ste?</small>

            <input id="autocomplete" name="lokalita" onFocus="geolocate()" type="text" aria-describedby="autocomplete1" placeholder="Odkiaľ ste (mesto/obec)" class="form-control form-control-sm">
       ...
       <div class="col-md-2">
        ...
        <script>
            ...
            function odosli_formular(){
                ...
                $.ajax({
                    type: "POST",
                    url: "piesen.tuto-poznam1.php",
                    data: $("#form_tutopoznam").serialize(), // serializes the form's elements.
                    success: function(data)
                    {
                        $('#tuto-poznam_vnutro').html(data); // show response from the php script.

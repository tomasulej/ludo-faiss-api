...
LEFT JOIN tempo ON piesne.id_tempo=tempo.id_tempo WHERE piesne.stav<>0 ORDER BY datum_digitalizacia DESC LIMIT 5";
...
$query3=mysql_query("SELECT log.id_piesen, piesne.nazov_dlhy, sum(log.pocet) as videnia FROM log LEFT JOIN piesne ON piesne.id_piesen=log.id_piesen WHERE datumcas > '2016-12-06 00:00:00' GROUP BY id_piesen ORDER BY videnia DESC LIMIT 20");
$piesne_top=array();

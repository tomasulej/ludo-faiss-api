...
(function() {
    ...
    function G(b, a) {
        var c = [],
            d;
        if (Array.isArray(b))
            for (d = 0; d < b.length; ++d) d in b && c.push([d,
                b[d]
            ]);
        else
    ...
    function K(b, a, c) {
        var d = 0,
            f, e, g = a[b];
        e = g.tup.indexOf("start"); - 1 < e && g.tup.splice(e, 1);
        var l = b;
    ...
    function T(b, a) {
        ...
        for (var c = 0, d = [], f = 0; f < b.length; ++f) {
            ...
            if (e instanceof z) e.tijd < c && (e.tijd = c), d.push(e), c = e.tijd;
            else {
                if (e.tijd < c) {
                    if ("z" == e.ns[0]) continue;
                    var g = d[d.length - 1];
                    if (g.tijd <= e.tijd)
                        if ("z" == g.ns[0]) g.dur = e.tijd - g.tijd, 0 == g.dur && pop(d), q("overlap in part %d, measure %d: rest shortened", [a.ixp + 1, a.ixm + 1]);
                        else {
    ...
    function M(b, a, c, d, f, e) {
        if ("name_tuple" == b[0]) d = d.shift(), a[0] && (b[1] = a[0] + ":" + b[1], b[2] = a[1] + ":" + b[2]), f.push(b), e.push.apply(e, L(d));
        else if (2 == b.length) d = d.shift(), c = ["name_tuple", "", ""], c[1] = b[0][1] + ":" + b[1][2], c[2] = b[0][2] + ":" + b[1][3], f.push(c), e.push.apply(e, L(d));
        else {
            var g, l, k;
            k = b[b.length - 1];
            a = k[0];
    ...
    A.prototype.prcnt = function(b) {
        for (var a in this.counters.note) 0 != this.getv("nopr", a) && q("part %d, voice %d has %d skipped non printable notes", [b, a, this.getv("nopr", a)]), 0 != this.getv("nopt", a) && q("part %d, voice %d has %d notes without pitch", [b, a, this.getv("nopt", a)]), 0 == this.getv("note", a) && q("part %d, skipped empty voice %d", [b, a])
    };
        ...
        for (h in this.vnums)
            if (0 != this.cnt.getv("note", h)) {
                ...
                for (m = 0; m < this.gMaten.length; ++m) {
                    ...
                    d = this.gLyrics;
                    if (0 != m)
                        for (n in e = this.gMaten[m][h], c = d[m][h], d = d[m - 1][h], v = v = n = void 0, d)
                            if (v = d[n][1], !(n in c) && v) {
                                v = e;
                                q = [];
                                for (r = 0; r < v.length; ++r)
                                    if (s = v[r], s instanceof w && !s.grace) {
                                        if ("z" == s.ns[0]) break;
                                        q.push("_")
                                    }(v = q.join(" ")) && (c[n] = [v, 0])
                            }
                ...
                for (l = 0; t.length;) {
                    m = 1;
                    for (e = t[0]; m < t.length &&
                        !(0 < this.cpl && e.length + t[m].length >= this.cpl) && !(0 < this.bpl && m >= this.bpl);) e += t[m], m += 1;
                    l += m;
                    p.add(e + " %" + l);
                    t.splice(0, m);
                    c = G(u, 1);
    ...
    n.prototype.matchSlur = function(b, a, c, d, f, e) {
        if (-1 != ["start", "stop"].indexOf(b))
            if (a || (a = "1"), a in this.slurBuf) {
                var g = this.slurBuf[a],
                    l = g[0],
                    k = g[1],
                    h = g[2],
                    g = g[3];
    ...
    n.prototype.doNote = function(b) {
        var a = new w(0, null),
            c = parseInt(b.find("voice").text() || "1");
        this.isSib && (c += 100 * (b.find("staff").text() || 1));
        var d = 0 < b.find("chord").length,
            f = b.find("pitch>step").text() || b.find("unpitched>display-step").text(),
            e = b.find("pitch>octave").text() || b.find("unpitched>display-octave").text(),
            g = 0 < b.find("rest").length,
        ...
        if (g || "no" != b.attr("print-object")) {
            ...
            if (b.find("unpitched").length) {
                var k = this.curClef[this.curStf[c]],
                    f = Q(f, parseInt(e), k, this.tstep),
                    e = b.find("instrument"),
                    e = e.length ? e.attr("id") : "dummyId",
                    e = this.drumInst[e] || J(g),
                    k = b.find("notehead"),
                    h = k.text().replace(" ", "-");
                "yes" == k.attr("filled") && (h += "+");
            ...
            for (e = k = 0; e < f.length; ++e) {
                var h = $(f[e]),
                    m = parseInt((h.attr("number") || "1").replace(/^.*verse/, ""));
                0 == m ? m = k + 1 : k = m;
                a.lyrs[m] = V(h)
            }
        ...
        for (e = 0; e < g.length; e++)
            if (l = $(g[e]),
                d = parseInt(l.attr("number") || "1"), k = l.find("sign").text(), h = "percussion" != k ? l.find("line").text() || "" : "", h = a[k + h] || "", k = l.find("clef-octave-change").text() || "0", h += {
                    ...
                    1: "+8",
                    2: "+15"
                }[k] || "", this.clefOct[d] = -parseInt(k), c && (h += " transpose=" + c), (k = b.find("staff-details>staff-lines").text()) && (h += " stafflines=" + k), this.curClef[d] = h, f) this.clefMap[d] = h;
            else
                for (l = this.stfMap[d], n = 0; n < l.length; ++n) m = l[n], d != this.curStf[m] && (t = d - this.curStf[m], this.curStf[m] = d, k = 0 < t ? "+" : "", this.msc.appendElem(m,
    ...
    n.prototype.doDirection = function(b) {
        ...
        if (c.length) {
            if (l = c.find("midi-instrument")) {
                ...
                (h = (f ? f - 1 : k) + "") && 0 < p.volpan && this.msc.appendElem(d, "[I:MIDI= " + (f ? "program" :
                    "channel") + " " + h + "]")
            }
    ...
    n.prototype.doPartList = function(b) {
        ...
        for (a = 0; a < f.length; ++a) {
            ...
            for (c = 0; c < g.length; ++c) {
                ...
                d = k[3]; - 90 <= d && 90 >= d && (d = (d + 90) / 180 * 127);
    ...
    n.prototype.doDefaults = function(b) {
        var a, c, d, f;
        this.doPageFmt && (a = b.find("defaults"), a.length && (b = a.find("scaling>millimeters").text(),
            c = a.find("scaling>tenths").text(), c = b / c / 10, b = a.find("page-layout>page-width").text() * c, d = a.find("page-layout>page-margins").first(), a = d.find("left-margin").text(), d = d.find("right-margin").text(), f = 10 * c / .2117, !p.scale && f && (p.scale = f.toFixed(2)), !p.pagewidth && b && (p.pagewidth = b.toFixed(2)), p.leftmargin || "" == a || (p.leftmargin = (a * c).toFixed(2)), p.rightmargin || "" == d || (p.rightmargin = (d * c).toFixed(2))))
    };
    n.prototype.locStaffMap = function(b) {
        ...
        for (var c = 0; c < b.length; c++) {
            var d = $(b[c]),
                f = parseInt(d.find("voice").text() || "1");
    ...
    n.prototype.addStaffMap = function(b) {
        var a, c, d, f, e, g, l = [],
            k = Object.keys(this.stfMap).sort();
        for (c = 0; c < k.length; ++c) {
            ...
            if (g.length)
                for (l.push(g.sort()), f = (e in this.clefMap) ? this.clefMap[e] : "treble", a = 0; a < g.length; ++a) d = g[a], p.clefs[d] = f
        }
        this.gStfMap.push(l)
    };
    n.prototype.addMidiMap = function(b, a) {
        var c = this.instMid[b],
            d, f = Object.keys(c);
        ...
        for (g in a) f = Object.keys(this.drumNotes).sort().filter(function(a) {
            ...
            return {
                nt: a.split(";")[1],
                step: h.drumNotes[a][0],
                midi: h.drumNotes[a][1],
                nhd: h.drumNotes[a][2]
            }

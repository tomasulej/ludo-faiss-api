...
$meta_image="data/".$piesen->id_piesen."/".$piesen->file_png;
$meta_url="http://".$_SERVER['SERVER_NAME']."/piesne/piesen.php?id".$piesen->id_piesen;

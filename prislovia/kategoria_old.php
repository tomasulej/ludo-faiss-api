...
$tmpl_kategoria= implode('', file('tmpl_kategoria_old.html'));
$tmpl_prislovie= implode('', file('tmpl_prislovie_old.html'));
$tmpl_hlavicka= implode('', file('tmpl_hlavicka_old.html'));

...
Bubbles = () ->
  ...
  updateActive = (id) ->
    ...
    if id.length > 0
       d3.select("#status").html("<h3>Vybral si slovo <span class=\"active\" id='#{id}'>#{id}</span>. Aj tak si kokot.</h3>")
...
texts = [
  {key:"sucasne",file:"../nadavka_csv.php?co=1",name:"Iba súčasné"},
#  {key:"vsetky",file:"../nadavka_csv.php",name:"Všetky nadávky"},
  {key:"jeb",file:"../nadavka_csv.php?co=2",name:"Iba tie, čo majú jebať"},
  {key:"prd",file:"../nadavka_csv.php?co=3",name:"Iba tie, čo majú prd"},
  {key:"zat",file:"../nadavka_csv.php?co=4",name:"Staré a neznáme"},
  {key:"ser",file:"../nadavka_csv.php?co=5",name:"Iba tie, čo majú ser"},
  {key:"mrd",file:"../nadavka_csv.php?co=6",name:"Iba tie, čo majú mrd"},
  {key:"drb",file:"../nadavka_csv.php?co=7",name:"Iba tie, čo majú drb"}
...
$ ->
  ...
  $('input[name="text-select"]').val(key)
  ...
  d3.select('input[name="text-select"]')
    .on "click", (e) ->
      key = $(this).value()
      alert(key)
      location.replace("#")
